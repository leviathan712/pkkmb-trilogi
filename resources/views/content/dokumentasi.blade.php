...
<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <div>
            ...
            <dotlottie-player src="https://lottie.host/f35c597e-0eba-4779-9798-efcee0e04627/iPkMjocMYq.json" background="transparent" speed="1" style="width: 100px; height: 100px;" loop autoplay></dotlottie-player>
        </div>
    ...
    <div class="grid sm:grid-cols-4 lg:grid-cols-4">
        <div>
            <div class="relative overflow-hidden transition duration-300 transform shadow-lg ">
    ...
    <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            <span class="relative inline-block">
                ...
                <span class="relative">Gallery 2</span>
            </span>
        </h2>
        <p class="text-base text-gray-700 md:text-lg">
            Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque rem aperiam, eaque
...
<!-- contoh gallery 3 -->
<!-- 
- Gallery ambil dari post instagram gausah minta akses login
- bisa kustomisasi feed
- tinggal pilih akun publik
- terbatas buat 200 load doang
   -->
<script src="https://static.elfsight.com/platform/platform.js" data-use-service-core defer></script>
<div class="elfsight-app-0a0419e2-7674-41fb-a76f-2f09df3b9c86" data-elfsight-app-lazy></div>

<!-- g 4 -->
<div class="tagembed-widget" style="width:100%;height:100%" data-widget-id="159365" view-url="https://widget.tagembed.com/159365"></div>
<script src="//widget.tagembed.com/embed.min.js" type="text/javascript"></script>
<iframe src="https://widget.tagembed.com/159365?view" style=" width:100%;height:500px;overflow: auto;" frameborder="0" allowtransparency="true"></iframe>